...
def efficientnet_b0(**kwargs):
    return EfficientNet('efficientnet_b0', **kwargs)


def efficientnet_b1(**kwargs):
    return EfficientNet('efficientnet_b1', **kwargs)


def efficientnet_b2(**kwargs):
    return EfficientNet('efficientnet_b2', **kwargs)


def efficientnet_b3(**kwargs):
    return EfficientNet('efficientnet_b3', **kwargs)
